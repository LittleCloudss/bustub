...
auto BPlusTreePage::IsLeafPage() const -> bool {
  return (page_type_ == IndexPageType::LEAF_PAGE) || (page_type_ == IndexPageType::ROOT_LEAF_PAGE);
}
auto BPlusTreePage::IsRootPage() const -> bool {
  return (page_type_ == IndexPageType::ROOT_LEAF_PAGE) || (page_type_ == IndexPageType::ROOT_INTERNAL_PAGE);
}
